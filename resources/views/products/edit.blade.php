                ...
                <div class="card-body">
                  <div class="form-group">
                   ...
                   <select name="category_id" id="category" class="form-control">
                    ...
                    <input type="text" class="form-control" name="sku" placeholder="Enter SKU Name" value="{{ $products->sku }}">
                    @if ($errors->has('sku'))
                    ...
                    <input type="text" class="form-control" name="cost_price" placeholder="Enter Cost Price" value="{{ $products->cost_price }}">
                    @if ($errors->has('cost_price'))
                        <span class="text-danger">{{ $errors->first('cost_price') }}</span><br>
                    @endif

                    <label for="exampleInputName">Retail Price</label>
                    <input type="text" class="form-control" name="retail_price" placeholder="Enter Retail Price" value="{{ $products->retail_price }}">
                    ...
                    <textarea name="description" id="" cols="30" rows="10" class="form-control" placeholder="Enter Description" value="{{ $products->description }}"></textarea>
